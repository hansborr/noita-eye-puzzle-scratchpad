...
- [CodeWarrior0 — Noita Eye Glyphs: Analytical Overview (Google Doc)](https://docs.google.com/document/d/1QeagH8TklJsd8iribMtT5LIRL91laOUU_tFcVl7OOqA/edit) — Key cryptanalytic findings (via search extract): frequency flat & not monoalphabetic; ciphertext not periodic; same-position letters across messages likely enciphered by DIFFERENT alphabets; six segments of the first three messages are isomorphs. Does not render via automated fetch; needs browser.
...
- [Toboter — Noita Eye Glyphs 'Progress' (Google Doc, dated 2024-01-25)](https://docs.google.com/document/d/1XMNXktCoSabnFWZf9rJFoaKMzsA1bbv7x1Xh9tXkKYk/edit) — Discord-server collation. States cipher is polyalphabetic; each ciphertext char depends on something beyond a single plaintext char; sizable shared sections between messages; the ~86,000 reading-order test. Linked from both wikis. Browser-only.
...
- [The Emerald Tablet — organized community work (Google Sheet)](https://docs.google.com/spreadsheets/d/1Aih_3v9BMbVI-MQQgWP51HTTplgRwXi2jRKYgyhPMao/edit) — Named on Fandom as the organized collection of prominent community work. Likely holds full per-message raw data. Renders 'Loading...' to fetchers; browser-only. (Distinct from the SirCapybar-linked 'Noita Eye Data' sheet 195Rtc8kj4b...)
...
- [Cauldron Room — The Noita Wiki](https://noita.wiki.gg/wiki/Cauldron_Room) — Source for the better-attributed 2021 'Arvi' remark to not be too concerned about the cauldron — the closest thing to a dev statement on Noita's grouped secrets, and a contrast to total dev silence on the eyes.
