...
| [handoff/gak-unknown-base-recovery/](handoff/gak-unknown-base-recovery/README.md) | **Next community-infrastructure track for Lymm's stated interest.** A scoped proving-ground plan for smaller GAK/deck-cipher recovery when the shared base permutation is hidden, starting with known-plaintext planted fixtures and exact re-encryption before any ciphertext-only experiment. |
