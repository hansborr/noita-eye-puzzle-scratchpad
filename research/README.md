...
| [handoff/gak-unknown-base-recovery/](handoff/gak-unknown-base-recovery/README.md) | **Built and scaling-calibrated community infrastructure for Lymm's stated interest.** Smaller hidden-base GAK/deck-cipher recovery with exact known-plaintext re-encryption. Preregistered base-completion marginalization replicated at `n=8,9`, recovering every retained plant while matched nulls stayed non-exact; top-source ranking and the eyes' missing known plaintext remain the blockers. |
