...
| [handoff/gak-unknown-base-recovery/](handoff/gak-unknown-base-recovery/README.md) | **Built and calibrated community infrastructure for Lymm's stated interest.** Smaller hidden-base GAK/deck-cipher recovery with exact known-plaintext re-encryption. Exact state SAT improved both development and a sealed holdout at `n=7`, `s=3`; the remaining measured bottleneck is the bounded top-source beam. |
