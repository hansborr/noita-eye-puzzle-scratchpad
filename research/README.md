...
| [handoff/gak-unknown-base-recovery/](handoff/gak-unknown-base-recovery/README.md) | **Built and scaling-calibrated community infrastructure for Lymm's stated interest.** Smaller hidden-base GAK/deck-cipher recovery with exact known-plaintext re-encryption. A preregistered fixed-evidence rung measured a sharp recovery drop from `n=7` to `n=8,9`, exposing both ranking loss and unresolved hidden-base completions; matched nulls stayed non-exact. |
