...
| [handoff/gak-unknown-base-recovery/](handoff/gak-unknown-base-recovery/README.md) | **Built and calibrated community infrastructure for Lymm's stated interest.** Smaller hidden-base GAK/deck-cipher recovery with exact known-plaintext re-encryption, including bounded local search and optional triple/CEGAR fallbacks. The late fallbacks did not improve sealed holdouts and stay disabled; task 03 is stopped pending a genuinely new algebraic or practice-ciphertext surface. |
