...
| [handoff/gak-unknown-base-recovery/](handoff/gak-unknown-base-recovery/README.md) | **Built and calibrated community infrastructure for Lymm's stated interest.** Smaller hidden-base GAK/deck-cipher recovery with exact known-plaintext re-encryption. Exact state SAT improved both development and a sealed holdout at `n=7`, `s=3`; optional 256-state retention closed all observed misses but did not beat the 96-state default on a fresh holdout. |
