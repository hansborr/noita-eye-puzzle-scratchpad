...
survived both structural gates below.
...
excess is 0.0 (real 0 - null mean 0.00), threshold 1722.0, so met=false. The detector is validated: the positive control clears its own
...
This negative is the expected, reportable outcome.
