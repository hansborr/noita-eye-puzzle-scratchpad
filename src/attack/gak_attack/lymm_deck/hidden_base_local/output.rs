...
pub(super) struct LocalSearchOutput {
    ...
    pub(super) state_sat_hypotheses_attempted: usize,
    pub(super) state_sat_hypotheses_unsat: usize,
    pub(super) state_sat_base_completions_attempted: usize,
    pub(super) state_sat_base_completions_unsat: usize,
    pub(super) state_sat_base_completion_cap_exhausted: usize,
    pub(super) state_sat_exact_models: usize,
    pub(super) state_sat_variables: usize,
    pub(super) state_sat_clauses: usize,
    pub(super) state_sat_replay_event_evaluations: usize,
    pub(super) state_sat_elapsed: Duration,
