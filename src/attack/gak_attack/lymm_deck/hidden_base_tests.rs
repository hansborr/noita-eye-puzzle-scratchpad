...
#[test]
fn hidden_base_local_triple_repair_recovers_retained_weak_restart_stall() {
    let fixture_seed = mix_seed(0x7769_6465_5f74_3301, 0x6c73_7265_636f_7600 ^ 2);
    let fixture = local_s3_weak_restart_fixture(fixture_seed);
    let base_config = local_s3_solver_config(&fixture.spec, fixture_seed);
...
fn local_s3_weak_restart_fixture(seed: u64) -> super::HiddenBaseFixture {
    plant_hidden_base_fixture(&HiddenBaseFixtureConfig {
        n: 7,
        pt_alphabet: "ABCDEF".to_owned(),
        swap_budget: 3,
