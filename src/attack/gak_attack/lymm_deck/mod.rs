...
pub use recovery::{
    ...
    LetterRecoveryVerdict, NullControlReport, PositiveControlReport, RecoveredLetter,
    RecoveryReport, RoundTripReport, SwapRecoveryConfig, SwapRecoveryError, SwapRecoveryStats,
    gak_swap_self_test, recover_known_plaintext_swaps, round_trip_check,
};
pub use spec::{
